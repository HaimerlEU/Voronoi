# from https://www.youtube.com/watch?v=LwpqA2WMR_8
...
# this draws multiple boxes
if 0:
    boxes = MultiPolygon([box(0, 0, 10,100), box(20,20,30,100)])
    plot_polys(boxes)
    plt.show()

# inflated boxes testing for intersection
if 0:
    box1 = box(0, 0, 10,100)
    # inflated box
...
if 1:
    ...
    plt.clf()
    mls2 = MultiLineString([LineString([(0,0),(0,1)]),
                            ((0,1),(1,1),(1,0),(0,0))])
    p2 = polygonize(mls2)
    plot_polys(p2)
    plt.show()
